...
CREATE INDEX idx_fact_relationship_custom_1 ON fact_relationship (domain_concept_id_1 ASC, fact_id_1 ASC, domain_concept_id_2 ASC, fact_id_2 ASC);

CREATE INDEX idx_note_stable_identifier_full_1 ON note_stable_identifier (note_id ASC);
CREATE INDEX idx_note_stable_identifier_full_2 ON note_stable_identifier (stable_identifier_path ASC, stable_identifier_value ASC);

CREATE INDEX idx_procedure_occurrence_stable_identifier_1 ON procedure_occurrence_stable_identifier (procedure_occurrence_id ASC);
CREATE INDEX idx_procedure_occurrence_stable_identifier_2 ON procedure_occurrence_stable_identifier (stable_identifier_path ASC, stable_identifier_value_1 ASC);