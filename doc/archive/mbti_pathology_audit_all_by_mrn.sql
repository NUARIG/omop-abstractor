...
FROM fsm_analytics_specialized.pathology_fact.pathology_case pc JOIN nm_bi.dim.vw_patient p ON pc.patient_ir_id = p.ir_id AND p.is_current = 1
																...
																JOIN fsm_analytics_specialized.pathology_fact.pathology_case_report prc ON pc.pathology_case_key = prc.pathology_case_key
                                                                JOIN fsm_analytics_specialized.pathology_fact.pathology_case_report_section prcs ON prc.pathology_case_report_key = prcs.pathology_case_report_key AND prcs.section_description = 'Final Diagnosis'
