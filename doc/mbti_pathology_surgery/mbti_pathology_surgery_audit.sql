...
SELECT  orc.or_case_id
      ...
      , (SELECT count(*) FROM fsm_analytics.pathology_map.pathology_and_surgical_case_map map WHERE map.pathology_case_key = pc.pathology_case_key AND map.surgical_case_key = sc.surgical_case_key) AS present_map_count
      , pc.group_name
      , pc.group_desc
      , pc.snomed_code
      , pc.snomed_name
