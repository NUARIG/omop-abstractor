...
where  nlc.predicate = 'has_metastatic_cancer_primary_site'
...
where nlc1.predicate = 'has_metastatic_cancer_primary_site'
...
and not exists(
  ...
  and aas.predicate = 'has_metastatic_cancer_primary_site'
  and (
