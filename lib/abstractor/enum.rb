module Abstractor
  module Enum
    ...
    ABSTRACTOR_SUGGESTION_SYSTEM_REJECTED_REASONS = [ABSTRACTOR_SUGGESTION_SYSTEM_REJECTED_REASON_NO_SECTION_MATCH, ABSTRACTOR_SUGGESTION_SYSTEM_REJECTED_REASON_NEGATED, ABSTRACTOR_SUGGESTION_SYSTEM_REJECTED_NO_ANCHOR]
  end
end