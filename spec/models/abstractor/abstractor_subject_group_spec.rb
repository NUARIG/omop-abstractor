...
describe Abstractor::AbstractorSubjectGroup do
  ...
  it "validates that abstractor_subject_group cardinality is a number", focus: false do
  ...
  it "validates that abstractor_subject_group cardinality is greater than 0", focus: false do
