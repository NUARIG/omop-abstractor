...
describe PathologyCase do
  before(:each) do
    ...
    @abstractor_subject_abstraction_schema_has_cancer_histology = Abstractor::AbstractorSubject.create(:subject_type => NoteStableIdentifier.to_s, :abstractor_abstraction_schema => @abstractor_abstraction_schema_has_cancer_histology)
    ...
    @abstractor_subject_abstraction_schema_has_cancer_site = Abstractor::AbstractorSubject.create(:subject_type => NoteStableIdentifier.to_s, :abstractor_abstraction_schema => @abstractor_abstraction_schema_has_cancer_site)
