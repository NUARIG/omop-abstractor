...
module OmopAbstractor
  module SpecSetup
    ...
    def self.custom_site_synonyms
      site_synonyms = CSV.new(File.open('lib/omop_abstractor/setup/data/custom_site_synonyms.csv'), headers: true, col_sep:',', return_headers: false)
    ...
    def self.site_categories
      site_categories = CSV.new(File.open('lib/omop_abstractor/setup/data/site_site_categories.txt'), headers: true, col_sep:"\t", return_headers: false)
    ...
    def self.laterality
      laterals = CSV.new(File.open('lib/omop_abstractor/setup/data/icdo3_sites_with_laterality.txt'), headers: true, col_sep:"\t", return_headers: false)
    ...
    def self.radiation_therapy_prescription
      abstractor_namespace_radiation_therapy_prescription = Abstractor::AbstractorNamespace.where(name: 'Radiation Therapy Prescription', subject_type: NoteStableIdentifier.to_s, joins_clause: '', where_clause: '').first_or_create
      list_object_type = Abstractor::AbstractorObjectType.where(value: 'list').first
      radio_button_list_object_type = Abstractor::AbstractorObjectType.where(value: 'radio button list').first
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: prescription_date_abstractor_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_radiation_therapy_prescription.id)
      Abstractor::AbstractorAbstractionSource.create(abstractor_subject: abstractor_subject, from_method: 'note_text', abstractor_abstraction_source_type: source_type_nlp_suggestion, abstractor_rule_type: unknown_rule_type)
    ...
    def self.surgery
      ...
      abstractor_object_value.save
      Abstractor::AbstractorAbstractionSchemaObjectValue.create(abstractor_abstraction_schema: imaging_confirmed_extent_of_resection_abstraction_schema, abstractor_object_value: abstractor_object_value)
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: imaging_confirmed_extent_of_resection_abstraction_schema)
    ...
    def self.imaging_exam
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: moomin_major_abstractor_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_1.id)
      abstractor_object_values = []
      abstractor_object_value = nil
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: dat_abstractor_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_1.id)
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: moomin_minor_abstractor_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_2.id)
      abstractor_object_values = []
      abstractor_object_value = nil
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: recist_response_abstractor_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_2.id)
      ...
      Abstractor::AbstractorAbstractionSchemaObjectValue.create(abstractor_abstraction_schema: recist_response_abstractor_abstraction_schema, abstractor_object_value: abstractor_object_value)
      Abstractor::AbstractorAbstractionSource.create(abstractor_subject: abstractor_subject, from_method: 'note_text', abstractor_rule_type: v_rule, abstractor_abstraction_source_type: source_type_nlp_suggestion)
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: anatomical_location_abstractor_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_2.id)
      ...
      [abstractor_namespace_imaging_exams_1, abstractor_namespace_imaging_exams_2].each do |namespace|
        abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: diagnosis_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: namespace.id)
        Abstractor::AbstractorAbstractionSource.create(abstractor_subject: abstractor_subject, from_method: 'note_text', abstractor_rule_type: v_rule, abstractor_abstraction_source_type: source_type_nlp_suggestion)
        ...
        abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: diagnosis_duration_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: namespace.id)
        Abstractor::AbstractorAbstractionSource.create(abstractor_subject: abstractor_subject, from_method: 'note_text', abstractor_rule_type: v_rule, abstractor_abstraction_source_type: source_type_nlp_suggestion)
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: score_1_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_3.id)
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: score_2_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_3.id)
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: falls_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_3.id)
      Abstractor::AbstractorAbstractionSource.create(abstractor_subject: abstractor_subject, from_method: 'note_text', abstractor_rule_type: v_rule, abstractor_abstraction_source_type: source_type_nlp_suggestion)
      ...
      abstractor_subject = Abstractor::AbstractorSubject.create(subject_type: NoteStableIdentifier.to_s, abstractor_abstraction_schema: freezing_abstraction_schema, namespace_type: Abstractor::AbstractorNamespace.to_s, namespace_id: abstractor_namespace_imaging_exams_3.id)
      Abstractor::AbstractorAbstractionSource.create(abstractor_subject: abstractor_subject, from_method: 'note_text', abstractor_rule_type: v_rule, abstractor_abstraction_source_type: source_type_nlp_suggestion)
